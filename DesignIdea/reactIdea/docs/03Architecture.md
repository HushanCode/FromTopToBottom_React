...
### (4) “归”阶段在[completeWork](https://github.com/facebook/react/blob/970fa122d8188bafa600e9b5214833487fbf1092/packages/react-reconciler/src/ReactFiberCompleteWork.new.js#L652)
...
+ 更新节点
  + 根据props和type先后判断是否可以复用
    + 可以复用，判断是否需要更新
    + 不可以，则调用reconcileChild进行diff，生成带标签的新的子节点
+ 挂载节点
  + 根据类型生成新的节点
